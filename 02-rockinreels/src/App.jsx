  ...
  return (
    <div className="cont-app">
      ...
      <div className="cap00 capitulos">
        ...
        <button onClick={() => setCapitulo01(!capitulo01)}>Iniciar Jogo</button>
      </div>
      ...
      {capitulo02 && 
      <div className="capitulo02 capitulos">
      ...
      {capitulo03 && 
      <div className="capitulo03 capitulos">
      ...
      {capitulo04 && 
      <div className="capitulo04 capitulos">
      ...
      {capitulo05 && 
      <div className="capitulo05 capitulos">
      ...
      {capitulo06 && 
      <div className="capitulo06 capitulos">
        <h2></h2>
        <p># 06: Não assinar o contrato
      ...
      {capitulo07 && 
      <div className="capitulo07 capitulos">
      ...
      {capitulo08 && 
      <div className="capitulo08 capitulos">
      ...
      {capitulo09 && 
      <div className="capitulo09 capitulos">
        <h2># 09: Rejeita HT</h2>
        <p>
      ...
      {capitulo10 && 
      <div className="capitulo10 capitulos">
      ...
      {capitulo11 && 
      <div className="capitulo11 capitulos">
